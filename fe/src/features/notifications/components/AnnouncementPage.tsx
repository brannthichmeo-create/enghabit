...
import { AuditTargetType, UserRole, createAnnouncementSchema } from '@enghabit/shared';
...
export function AnnouncementPage(): JSX.Element {
  ...
  return (
    <div>
      ...
      />
      <AdminLogTabs targetTypes={[AuditTargetType.ANNOUNCEMENT]} mainLabel="Soạn thông báo">
