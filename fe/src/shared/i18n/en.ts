...
export const EN: Dictionary = {
  ...
  'Theo múi giờ của bạn. Đã check-in thì không nhắc nữa.':
    "In your own time zone. No reminder once you've checked in.",
  ...
  '{date} — chưa check-in': '{date} — not checked in',
  '{date} — không phải ngày đến hạn': '{date} — not a scheduled day',
  '{done}/{due} ngày đến hạn': '{done}/{due} scheduled days',
  'Tuần này: đã xong': 'This week: done',
  'Tuần này: chưa làm': 'This week: not yet',
  ...
  'Đã check-in "{name}" ngày này.': 'You checked in "{name}" on this day.',
