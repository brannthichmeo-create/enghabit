...
export const EN: Dictionary = {
  ...
  'Các mốc nhắc trong ngày': 'Reminder times',
  'Đã đặt {n}/{max} mốc': '{n} of {max} set',
  'Thêm mốc': 'Add time',
  'Đã đạt số mốc tối đa': 'You have reached the maximum number of reminders',
  'Chưa có mốc nhắc nào. Thêm một mốc để hệ thống nhắc bạn học.':
    'No reminder times yet. Add one and the app will nudge you.',
  'Cả tuần': 'Every day',
  'Đang tắt': 'Off',
  'Bật': 'On',
  'Tắt': 'Off',
  'Xoá mốc nhắc': 'Delete reminder',
  'Xoá mốc nhắc lúc {time}?': 'Delete the {time} reminder?',
  'Đã xoá mốc nhắc': 'Reminder deleted',
  'Đã thêm mốc nhắc': 'Reminder added',
  'Tên mốc (tuỳ chọn)': 'Name (optional)',
  'Ví dụ: Trước khi đi làm': 'For example: Before work',
  'Chọn ít nhất một ngày cho mốc này.': 'Pick at least one day for this reminder.',
  'Huỷ': 'Cancel',
